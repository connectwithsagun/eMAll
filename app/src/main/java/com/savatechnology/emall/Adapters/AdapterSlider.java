...
public class AdapterSlider extends
    ...
    public void renewItems(List<SliderImageList> sliderItems) {
    ...
    public void addItem(SliderImageList sliderItem) {
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
        ...
        SliderImageList sliderItem = mSliderItems.get(position);
