package com.savatechnology.emall.Data;
...
//    public static List<FavouriteList> getFavouriteList(Context ctx) {
//        List<FavouriteList> items = new ArrayList<>();
//        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.product_name);
//        TypedArray drw_arr_bg = ctx.getResources().obtainTypedArray(R.array.supplier_name);
//        String title_arr[] = ctx.getResources().getStringArray(R.array.product_name);
//        String brief_arr[] = ctx.getResources().getStringArray(R.array.list_icon);
//        TypedArray drw_arr1 = ctx.getResources().obtainTypedArray(R.array.image);
//        for (int i = 0; i < drw_arr.length(); i++) {
